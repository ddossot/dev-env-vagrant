...
# user name
user="twilight"
password="All the ponies in this town are crazy!"

# GECOS field (comma-separated)
# Full name, Building and room number, Phone number, Other contact information
gecos="Princess Twilight Sparkle,,,"

# primary group
primary_group="secret"
secondary_groups="confidential,restricted,unclassified"
